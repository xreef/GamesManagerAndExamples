...
public class ImageLoader {
	...
	public ImageLoader(String filePath, String filecfg){
		initLoader();
	...
	// extract name before '.' of filename
	{
	   ...
	   */
	   {
	     try {
	       BufferedImage im =  ImageIO.read(getClass().getResource(IMAGE_PATH + fnm) );
	       ...
	       System.out.println("Load Image error for " + IMAGE_PATH + "/" + fnm + ":\n" + e); 
	       return null;
	     }
	...
	// --------- load numbered images -------------------------------
	   ...
	   */
	   {
	     ...
	     if (tokens.countTokens() != 4)
	       ...
	       { 
	    	   System.out.println("Number width is incorrect for " + line);  
	       }
	   ...
	   */
	   {
	     if (number_width <= 0) {
	       System.out.println("number_width <= 0; returning null");
	       return null;
	     }

	     if (number_heigth <= 0) {
		       System.out.println("number_heigth <= 0; returning null");
		       return null;
		     }
