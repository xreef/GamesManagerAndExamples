...
import image.ShowImageBuffered;
...
public class TestImmagineBufferingPanel extends JPanel implements Runnable
{
  ...
  private TestImmagineBuffering wcTop;
  ...
  ShowImageBuffered sib;

  public TestImmagineBufferingPanel(TestImmagineBuffering wc, long period)
  {
    wcTop = wc;
    this.period = period;
...
//    });
  ...
  private void gameRender()
  {
    if (dbImage == null){
      ...
      if (dbImage == null) {
       ...
       dbg2D = (Graphics2D) dbImage.getGraphics( );
	      ...
	      dbg2D.fillRect (0, 0, PWIDTH, PHEIGHT);
      }
    }

    dbg2D.setColor(Color.white);
    dbg2D.fillRect (0, 0, PWIDTH, 50);
    ...
    dbg2D.drawString("Average FPS/UPS: " + df.format(averageFPS) + ", " +
...
//    Rectangle2D.Double square = new Rectangle2D.Double(r.nextInt(255),r.nextInt(255)+50,r.nextInt(255),r.nextInt(255));
//    g2d.fill(square);
	  sib.paint(g, this);
  }
