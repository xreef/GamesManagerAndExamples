...
public class FullScreenFrame2 extends FullScreenFrame1 implements Runnable
{
	 ...
	 */
	protected long renderLoopSpeed = 100;
	...
	public boolean render(Graphics g) 
	{
		...
		g.setColor(suprise);
		g.fillRect(0,0,r.nextInt(i),r.nextInt(j));
    ...
    public static void main(String[] args)
    {
		...
		if(defaultScreenDevice.isFullScreenSupported())
		{
			...
			FullScreenFrame2.printDisplayModes();
			...
			FullScreenFrame2 myFrame = null;
			
			if(fullScreenMode && !forceWindowedMode)
				myFrame = new FullScreenFrame2("FullScreenFrame2 Full Screen Mode", newMode);
			else
				myFrame = new FullScreenFrame2("FullScreenFrame2 Windowed Mode", false);
