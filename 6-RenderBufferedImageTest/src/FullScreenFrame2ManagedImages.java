 ...
 */
public class FullScreenFrame2ManagedImages extends FullScreenFrame1 implements
		Runnable {
	/**
	 * 
	 */
	 ...
	 */
	public FullScreenFrame2ManagedImages(String title, DisplayMode mode)
	 ...
	 * @throws java.awt.HeadlessException
	 */
	public FullScreenFrame2ManagedImages(String title, boolean undecorated)
			throws HeadlessException {
	...
	public void run() {
		x = getWidth();
		y = getHeight();
		imageURL = getClass().getResource(imageResourceName);
		if (imageURL == null) {
		...
		try {
			...
			System.out.println("Impossibile creare la bufferedImage "+e.getMessage());
			e.printStackTrace();
		}
	...
	/*
	* Read in an image Toolkit’s createImage(URL) method
	*/
	...
	/*
	Read in an image using Toolkit class’s method getImage(URL)
	*/
	...
	*/
	...
	public boolean render(Graphics g) {
		...
		if(image!=null)
		{
		   g.drawImage(image,r.nextInt(x),r.nextInt(y),this);
		}
		return true;
	}
	...
	public static void main(String[] args) {
		...
		if (defaultScreenDevice.isFullScreenSupported()) {
			...
			FullScreenFrame2ManagedImages.printDisplayModes();
		...
		FullScreenFrame2ManagedImages myFrame = null;

		if (fullScreenMode && !forceWindowedMode)
			myFrame = new FullScreenFrame2ManagedImages(
