 ...
 */
public class FullScreenFrame2BufferedImage extends FullScreenFrame1 implements Runnable
{
	/**
	 * 
	 */
	...
	/**
	 * The number of milliseconds to sleep before drawing the next frame. Normally set to 5
	 */
	 ...
	 */
	public FullScreenFrame2BufferedImage(String title, DisplayMode mode) throws HeadlessException
	{
		super(title,mode);
	 ...
	 * @throws java.awt.HeadlessException
	 */
	public FullScreenFrame2BufferedImage(String title, boolean undecorated) throws HeadlessException
	{
	...
	public boolean renderPausa(Graphics g){
		Random r = new Random();
		Color suprise = new Color(r.nextInt(255),r.nextInt(255),r.nextInt(255));
	...
	public boolean render(Graphics g) 
	{
		...
		if(image!=null)
		{
		   g.drawImage(image,r.nextInt(x-200),r.nextInt(y-200),this);
		}
    ...
    public static void main(String[] args)
    {
		...
		if(defaultScreenDevice.isFullScreenSupported())
		{
			...
			FullScreenFrame2BufferedImage.printDisplayModes();
			...
			FullScreenFrame2BufferedImage myFrame = null;
			
			if(fullScreenMode && !forceWindowedMode)
				myFrame = new FullScreenFrame2BufferedImage("FullScreenFrame2 Full Screen Mode", newMode);
			else {
				myFrame = new FullScreenFrame2BufferedImage("FullScreenFrame2 Windowed Mode", false);
